...
import static es.uvigo.esei.dai.hybridserver.utils.TestUtils.assertEqualsIgnoreSpaces;
...
extends JdbcTestCase {
	...
	public void testSimpleGet() throws IOException {
		...
		for (String[] page : pages) {
			...
			assertEqualsIgnoreSpaces(page[2], content);
		}
	}
	...
	public void testConvertedGet() throws IOException {
		...
		for (String[] page : pages) {
			...
			assertEqualsIgnoreSpaces(page[3], content);
		}
	}
}